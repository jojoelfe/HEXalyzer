...
#Parsing arguments
parser = argparse.ArgumentParser(description="Analyze mass spectra for presence of peptide fragments")
parser.add_argument('parameters', metavar ='parameters', type=str, help="Parameters in JSON format")
parser.add_argument('file', metavar ='file', type=str, help="Mass spectrometry file in mzml format")
args = parser.parse_args()

#Reading input files
with open(args.parameters) as parameters_file:
